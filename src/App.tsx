...
const posts: Posts[] = [
  {
    ...
    author: {
      avatarUrl:
        'https://avatars.githubusercontent.com/u/80259818?s=400&u=f320efab966377494abc20a241927e2d78a416ea&v=4',
      name: 'Isaac Cidreira',
  ...
  },
  {
    ...
    content: [
      { type: 'paragraph', content: 'Olá pessoal 💕' },
      {
        type: 'paragraph',
        content:
          'Finalizei mais um projeto no meu portfólio. É um projeto que fiz no NLW Return, evento da Rocketseat. O nome do projeto é Ignews ✨',
      },
      { type: 'link', content: 'jane.design/doctorcare' },
    ],
